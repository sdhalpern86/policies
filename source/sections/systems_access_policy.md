...
Access to 1healthy.world systems and application is limited for all users, including but not limited to workforce members, volunteers, business associates, contracted providers, consultants, and any other entity, is allowable only on a minimum necessary basis. All users are responsible for reporting an incident of unauthorized user or access of the organization’s information systems. These safeguards have been established to address the HIPAA Security regulations including the following:
...
* Requests for access to 1healthy.world systems and applications is made formally to the CTO, CEO, Privacy Officer, or Security Officer.
* Access is not granted until receipt, review, and approval by the 1healthy.world Security Officer;
* The request for access is retained for future reference.
* All access to 1healthy.world systems and services are reviewed and updated on an bi-annual basis to assure proper authorizations are in place commensurate with job functions. The form used to conduct account review is [here](https://docs.google.com/a/catalyze.io/forms/d/1oeejMta4XLiUsdH2gTKQ-glec6DBiwPJoY9F60HmPWk/viewform).
* Any 1healthy.world workforce member can request change of access using this [form](https://docs.google.com/a/catalyze.io/forms/d/1ySICzCyEEdNqxHHErjlJqREBijwxs9z72L-rWXrxkm0/viewform).
...
* In the case of non-personal information, such as generic educational content, identification and authentication may not be required. This is the responsibility of 1healthy.world Customers to define, and not 1healthy.world.
...
* Generic accounts are not allowed on 1healthy.world systems.
...
* 1healthy.world maintains a minimum necessary approach to access to Customer data. As such, 1healthy.world, including all workforce members, does not readily have access to any ePHI.

## Access Authorization

* Role based access categories for each 1healthy.world system and application are pre-approved by the Security Officer or CTO.
* 1healthy.world utilizes hardware and software firewalls to segment data, prevent unauthorized access, and monitor traffic for denial of service attacks.
...
* Access to the 1healthy.world systems and applications is controlled by requiring unique User Login ID’s and passwords for each individual user and developer.
...
* Shared accounts are not allowed within 1healthy.world systems or networks.
...
1healthy.world's workstations are company controlled, and all are laptop Microsoft or Apple products running Windows 10 or the macOS operating systems.

* Workstations may not be used to engage in any activity that is illegal or is in violation of organization’s policies.
* Access may not be used for transmitting, retrieving, or storage of any communications of a discriminatory or harassing nature or materials that are obscene or “X-rated”. Harassment of any kind is prohibited. No messages with derogatory or inflammatory remarks about an individual’s race, age, disability, religion, national origin, physical attributes, sexual orientation, gender identity, or health condition shall be transmitted or maintained. No abusive, hostile, profane, or offensive language is to be transmitted through organization’s system.
...
* Transmitted messages may not contain material that criticizes organization, its customers, its providers, its employees, or others.
* Users may not misrepresent, obscure, suppress, or replace another user’s identity in transmitted or stored messages.
* Workstation hard drives will be encrypted using built-in OS systems including but not limited to BitLocker and FileVault. 
* All workstations have firewalls enabled to prevent unauthorized access unless explicitly granted.

## Wireless Access Use

* 1healthy.world production systems are not accessible directly over wireless channels.
...
* Wireless networks managed within 1healthy.world non-production facilities (offices, etc) are encrypted using WPA2 
...
1healthy.world does not use paper records for any sensitive information. Use of paper for recording and storing sensitive data is against 1healthy.world policies.

## Password Management

* User IDs and passwords are used to control access to 1healthy.world systems and may not be disclosed to anyone for any reason.
...
* On all production systems and application in the 1healthy.world environment, password configurations are set to require that passwords are a minimum of 8 character length, 90 day password expiration, account lockout after 5 invalid attempts, password history of last 4 passwords remembered, and account logoff after 15 minutes of inactivity.
...
## Add-On Customer Access to Systems

1healthy.world grants Add-On customers secure system access via VPN connections. This access is only to Customer-specific systems, no other systems in the environment. These connections are setup at customer deployment. These connections are secured and encrypted and the only method for customers to connect to 1healthy.world hosted systems.

In the case of data migration, 1healthy.world does, on a case by case basis, support customers in importing data. In these cases 1healthy.world support SCP assuring all data is secured and encrypted in transit.

In the case of an investigation, 1healhty.world will assist customers, at 1healthy.world's discretion, and law enforcement in forensics.
